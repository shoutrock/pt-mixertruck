...
!function (o) {
    ...
    o.modal = function (e, s) {
        ...
        if (t.push(this), e.is("button"))if (n = e.attr("href"), /^#/.test(n)) {
    ...
    }, o(document).on("click.modal", 'a[rel="modal:close"]', o.modal.close), o(document).on("click.modal", 'button[rel="modal:open"]', function (t) {
